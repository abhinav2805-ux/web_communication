  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <main className="flex flex-col lg:flex-row h-[calc(100vh-5rem)] overflow-hidden">
        ...
        <div className="w-full lg:w-2/5 h-[50vh] lg:h-full overflow-auto border-b lg:border-b-0 lg:border-r border-gray-700">
          <Panel1 />
        </div>

        {/* Panel 2: Servo Node Controller */}
        <div className="w-full lg:w-3/5 h-[50vh] lg:h-full overflow-auto">
          <Panel2 />
        </div>
      </main>
    </div>
